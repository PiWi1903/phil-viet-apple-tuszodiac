$(document).ready(function (e) {
    ...
    var n = document.querySelector(".country_action").innerHTML,
        ...
        (e.managerDialog = [
            {
                text: "Hi!<br>Ako si Apple Paguio. Isang Physic reader at Astrologo. Laging tumulong sa kapwa, lalo na sa mga mahihirap at may utang.<br>Salamat sa paggalaw ng mga konstelasyon, hinuhulaan ko na: Ngayong buwan ay magkakaroon ng 3 masuwerteng zodiac sign na may pagkakataong baguhin ang kanilang buhay. Ikaw ba ang taong ito?",
            },
            {
